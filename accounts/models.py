...
class City(models.Model):
    province = models.ForeignKey(Province, on_delete=models.CASCADE, related_name='province_cities')
    name = models.CharField(max_length=30)
...
class HealthCenter(models.Model):
    city = models.ForeignKey(City, on_delete=models.CASCADE, related_name='city_healthCenter')
    name = models.CharField(max_length=30)
...
class Village(models.Model):
    health_center = models.ForeignKey(HealthCenter, on_delete=models.CASCADE, related_name='health_village')
    name = models.CharField(max_length=30)
